...
Требования:
    ...
    3. SQLite база должна существовать в data/payment_gateway.db
"""
...
# Конфигурация
SQLITE_PATH = Path(__file__).parent.parent / "data" / "payment_gateway.db"
POSTGRES_DSN = "postgresql://gateway:payment_gateway_password@localhost:5432/payment_gateway"
